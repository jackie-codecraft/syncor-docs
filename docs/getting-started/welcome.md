...
|------|-----------------|
| **Requester** | Browse products, create purchase requests, track order status, create sourcing requests |
| **Approver** | Review and approve/reject purchase requests, view budget impact, manage out-of-office status |
| **Sourcing Manager** | View and manage sourcing requests from users who need products not in the catalog |
